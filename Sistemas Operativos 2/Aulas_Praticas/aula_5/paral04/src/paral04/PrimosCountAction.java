...
public class PrimosCountAction extends RecursiveAction 
{
    ...
    /**
     * Contagem de primos...
     * Note que não existem as classes auxiliares do exemplo anterior.
     * @return 
     */
    ...
    {
       PrimosCountAction contaPrimos = new PrimosCountAction(0,2000000);
