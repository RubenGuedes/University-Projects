...
public class BookStore 
{
	...
	public static final double[] RATIOS = { -1, 1, 0.95, 0.9, 0.8, 0.75 };
    ...
    public double search(Map<String, Double> cache, int[] counts) 
    {
